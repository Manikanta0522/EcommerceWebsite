...
<body class="bg-gray-50 dark:bg-000000 min-h-screen flex">
    ...
    <main class="flex-1 p-6 md:ml-64 flex items-center justify-center">
        ...
        <div class="bg-white dark:bg-000000 rounded-xl shadow-md p-8 w-full max-w-md transform transition-transform hover:scale-102">
            ...
            %>
            <% if (error != null) { %>
                <p class="text-000000 dark:text-ffe8db text-center mb-4"><i class="fas fa-exclamation-circle mr-2"></i> <%= error %></p>
            <% } %>
            <% if ("1".equals(registered)) { %>
                <p class="text-5682b1 dark:text-739ec9 text-center mb-4"><i class="fas fa-check-circle mr-2"></i> Registration successful. Please login.</p>
            <% } %>
            ...
            <a href="<%=request.getContextPath()%>/jsp/register.jsp"
               class="block text-center mt-6 text-5682b1 dark:text-739ec9 hover:underline">
